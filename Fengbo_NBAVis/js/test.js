...
function update() {  
    ...
    if (selectedTeam == "All Teams") {
        ...
        teamStarterDataPath = "data/player-stats-by-team/" + selectedTeam + " Starters.csv";
        teamReserveDataPath = "data/player-stats-by-team/" + selectedTeam + " Reserves.csv";
        teamStatsDataPath = "data/team-stats/" + selectedTeam + " Team Stats.csv";
        teamPlayersDataPath = "data/team-players/" + selectedTeam + " Players.json";
